...
# Test for user profiles controller
  ...
  test 'should create user_profile' do
    assert_difference('UserProfile.count') do
      post user_profiles_url,
           params: { user_profile: { address: @user_profile.address, countryCode: @user_profile.countryCode,
                                     firstName: @user_profile.firstName, lastName: @user_profile.lastName,
                                     postalCode: @user_profile.postalCode, provinceCode: @user_profile.provinceCode } }
    end
