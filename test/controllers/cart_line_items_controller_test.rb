...
# Test for cart line items controller
class CartLineItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create cart_line_item' do
    assert_difference('CartLineItem.count') do
      post cart_line_items_url,
           params: { cart_line_item: { ShoppingCart_id: @cart_line_item.ShoppingCart_id,
  ...
  test 'should update cart_line_item' do
    patch cart_line_item_url(@cart_line_item),
          params: { cart_line_item: { ShoppingCart_id: @cart_line_item.ShoppingCart_id,
                                      product_id: @cart_line_item.product_id } }
